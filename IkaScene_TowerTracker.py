...
class IkaScene_TowerTracker:
	...
	def towerPos(self, context):
		img = context['engine']['frame'][self.tower_line_top:self.tower_line_top + self.tower_line_height, self.tower_left:self.tower_left + self.tower_width]
	...
	def __init__(self):
		...
		self.ui_tower_mask = self.ui_tower_mask[self.tower_line_top:self.tower_line_top + self.tower_line_height, self.tower_left:self.tower_left + self.tower_width]
