...
### ブキ、ランク、ウデマエ、K/Dなどを誤認識する

これらの画像／文字認識データはほぼすべて IkaLog 開発者の環境のスクリーンショットを
ベースに作成しています。ただ、キャプチャ環境の差異などによりユーザごとに入力データが
違う可能性があります。

認識率が低いなどの問題がある場合は Dropbox, Google Drive などにデータを置いて
...
- 各種バグ報告や修正コード、修正案、方向性の検討について様々な方から意見やアイデアをいただきました。
  - @mzsm_j （Pythonコードの品質面などでたいへんお世話になっております)
  - @fetus_hina (IkaLog がデータを投げられる [stat.ink](http://stat.ink)を作られています
  - @itooon (WebCam 対応ほか、技術的課題に対して色々と助言をいただいております)
