...
class Spl2GameSpecialMeter(Scene):

    def reset(self):
        super(Spl2GameSpecialMeter, self).reset()
    ...
    def match_no_cache(self, context):
        ...
        if self.is_another_scene_matched(context, 'Spl2GameMap'):
            return False
...
if __name__ == "__main__":
    Spl2GameSpecialMeter.main_func()
